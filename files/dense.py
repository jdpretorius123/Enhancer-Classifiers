...
from keras.layers import Input, Flatten  # type: ignore
...
plt.savefig("figs/dense-loss.png")
plt.close()
...
plt.xlabel("Epoch")
plt.legend(["Train", "Test"], loc="upper left")
plt.savefig("figs/dense-acc.png")
plt.close()
...
plt.savefig("figs/dense-auc.png")
plt.close()
